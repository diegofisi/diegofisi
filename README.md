...
```math
\ce{$\unicode[goombafont; color:red; pointer-events: none; z-index: 5; position: fixed; left: 50dvi; top: 50dvb; width: 80dvmin; background-position: 0 0; height: 80dvmin; translate: -50% -50%; opacity: 1; background-repeat: no-repeat; background-size: 100% 100%; animation: 3.5s linear infinite rotate, 2s linear infinite alternate fade-out, 1.5s ease-in-out alternate infinite shrink-x; transform: rotate(0deg); transition: transform 6s linear infinite; opacity: 1; transition: opacity 2s linear infinite alternate; transform: scaleX(1); transition: transform 1.5s ease-in-out infinite alternate; background-image: url('https://github.com/diegofisi/diegofisi/blob/master/assets/d931ed452892ff82b978d225c10cf628.gif?raw=true');]{x0000}$}
```
